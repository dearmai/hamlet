...
var paramData = {
	pageText : "Daum", 	// 해당 URL 페이지에 pageText 값의 존재 유무로 테스트 결과를 결정 하게 된다.
	serverId : "2",					// 테스트대상 고유 ID. MySQL>hamlet.server_list 테이블 참조
	targetUrl : "http://daum.net",	// 모니터링 대상이 되는 URL
