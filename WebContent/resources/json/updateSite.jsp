...
<%
	...
	out.println( hamletMyBatis.updateSite(action, server_id, server_name, parent_id, server_url, is_login_flow, login_form_query, id_name, id_value, password_name, password_value, success_string)); 
%>
