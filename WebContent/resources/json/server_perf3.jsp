...
<%
	SystemStatusReader s = new SystemStatusReader();
	System.out.println("cpu" + s.cpuUsage(s.AVERAGE));
%>
<%! 
/**
 ...
 class SystemStatusReader
{
     ...
     */
    public Double cpuUsage (int measureMode) throws Exception {
     ...
     */
    public HashMap<String, Integer> memoryUsage () throws Exception {
